...
%{\faCaretRight} The application fetches real time cricket scores for cricket matches all around the globe. The app also shows ball by ball updates, full score card and charts to show winning chances of teams after each over.
}
...
{}
{}
{Project was done in collaboration with students from Electronics department.Received \nth{1} prize in Sustainable Development in Prakalpa 2014-KJSCE.\bfseries{(Java)}}
