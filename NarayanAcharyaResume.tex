...
\begin{document}
	...
	\resumeSubHeadingListStart
	\item{Built Deep Learning pipeline to improve perceived video quality by enhancing regions with text. Reduced inference time by $\sim$75\% for text detection under challenging constraints without reducing precision \& recall. Evaluated multiple lightweight backbone networks and techniques like quanitzation, post-processing optimization to improve inference speed by 2x-4x.}
