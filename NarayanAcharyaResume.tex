...
\begin{document}
	...
	\resumeSubHeadingListStart
	\item {Teaching Assistant for undergraduate course - Programming Abstractions}
	\vspace{-2pt}
	...
	{Re-architected server-side services to support web based user interfaces for streaming real time data using WebSockets. Improved performance using smaller payload sizes and loadbalancing requests across cluster of replicated services.}
