...
\begin{document}
	...
	\resumeSubItem{Comment Toxicity Detection}{Achieved an AUC score of 0.98+ with creative pre-processing techniques coupled with Bi-GRU \& BERT for multi-label classification of toxicity levels in Wikipedia comments. }
	...
	\resumeSubItem{\href{https://github.com/narayanacharya6/WaveView}{WaveView \faGithub \space \faAndroid}}{Created Android/Java library for rendering/animating sinusoidal waves with 10k+ downloads.}
	\resumeSubHeadingListEnd
	...
	\vspace{-4pt}
	\item{
		\textbf{Frameworks \& Libraries}{: Spring, Android, iOS, Flask, TensorFlow, Keras, PyTorch, scikit-learn, NumPy, pandas, Hadoop, Dask, Spark, MapReduce, Kafka, Docker, Kubernetes, NoSQL, MongoDB}}
	\vspace{-4pt}
	\item{
