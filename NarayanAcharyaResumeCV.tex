...
\begin{document}
	...
	\vspace{-2pt}
	%\item{Courses: Data Science, Computer Vision, NLP, Algorithms, ML, Database Systems, Probability \& Stats.}
	%\vspace{-2pt}
	\item  {Course Work -}
	...
	%{Sentiment analysis using DAN and GRU, Dependency Parsing using Neural Nets, Relationship Extraction using GRU and CNN. Detecting toxicity in online conversations (Capstone).}
	...
	\vspace{-8pt}
	\item{
		\textbf{Frameworks \& Tools}{: Spring, Android, iOS, Jupyter Notebooks, TensorFlow, PyTorch, OpenCV, Angular, Pandas, Numpy, \LaTeX, Kafka, Zookeeper, Gradle, Maven, Elastic, Logstash, Kibana, Git, Bash, Linux}}
	\resumeSubHeadingListEnd
