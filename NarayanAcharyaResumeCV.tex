...
\begin{document}
	...
	\resumeSubHeadingListStart
	\item{Built Deep Learning pipeline for Video Codecs Team to improve perceived quality of video by enhancing regions with text. Reduced inference time by $\sim$75\% for text detection under challenging constraints without compromising on precision \& recall. Evaluated multiple lightweight backbone networks and other optimization techniques like quanitzation, hyperparameter tuning to further improve inference speed by 2x-4x.}
	...
	\vspace{-4pt}
	\item{
		\textbf{Frameworks \& Libraries}{: TensorFlow, Keras, PyTorch, OpenCV, scikit-learn, NumPy, pandas, Spring, Android, iOS}}
	\vspace{-4pt}
	\item{
